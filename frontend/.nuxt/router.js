...
const _674d2e6f = () => interopDefault(import('../pages/users/myprofile/_UpdateProduct/index.vue' /* webpackChunkName: "pages/users/myprofile/_UpdateProduct/index" */))
...
export const routerOptions = {
  ...
  routes: [{
    ...
    path: "/users/myprofile/:UpdateProduct",
    component: _674d2e6f,
    name: "users-myprofile-UpdateProduct"
  }, {
