...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/auth/login","method":"post","propertyName":"token"},"logout":{"url":"/auth/logout","method":"get"},"user":{"url":"/auth/me","method":"get","propertyName":false}},"tokenRequired":true,"tokenType":"Bearer","_name":"local"}))
